    ...
    <div class="mx-auto px-4 md:px-12 my-12 flex justify-center items-center">
        ...
        >
            <div class="col-span-2 text-center md:text-left">
                <span
                    class="text-blue-400 font-medium uppercase text-sm md:text-base"
                >
                ...
                <form name="subscribeToAlerts" @submit.prevent="publish">
                    <div class="relative">
                        ...
                        <input
                            ...
                            id="email"
                            v-model="form.email"
                            class="block w-full p-4 pl-10 text-sm text-gray-300 rounded-lg bg-gray-700 focus:ring-blue-500 focus:border-blue-500"
